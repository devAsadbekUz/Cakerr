-- Migration 76: Order Creator Tracking
-- Adds a persistent name for the creator of manual orders.

BEGIN;

-- 1. Add created_by_name column
ALTER TABLE public.orders 
ADD COLUMN IF NOT EXISTS created_by_name TEXT;

-- 2. Update POS-specific order creation RPC to handle the name
