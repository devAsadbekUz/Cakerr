...
const uz: Record<string, string | string[]> = {
    ...
    photoPriceNote: "📸 Rasm asosidagi tort narxi buyurtma berilgandan so'ng admin bilan kelishiladi.",
    ...
    stepSponge: "Biskvit",
    stepCream: "Krem",
    stepDecoration: "Bezak",
    stepReview: "Tekshirish",
    selectShape: "Tort shaklini tanlang",
    noShapes: "Shakllar mavjud emas",
    selectSize: "O'lchamini tanlang",
    diameter: "diametr",
    sizePriceNote: "Tanlangan o'lchamga qarab yakuniy narx turlicha bo'lishi mumkin.",
    selectSponge: "Biskvit (Asos) turini tanlang",
    selectCream: "Krem turini tanlang",
    addDecorations: "Bezaklarni qo'shing",
    specialMessage: "Maxsus xabar",
    textMode: "Matn",
    drawingMode: "Chizish",
    messagePlaceholder: "Masalan: Tug'ilgan kuning bilan!",
    ...
    howToCreate: "Tortni qanday yaratmoqchisiz?",
    stepByStep: "Bosqichma-bosqich",
    stepByStepDesc: "Shakl, hajm va bezaklarni o'zingiz tanlang",
    uploadPhoto: "Rasm yuklash",
    uploadPhotoDesc: "O'zingiz yoqtirgan tort rasmini yuklang",
    uploadPhotoFormDesc: "O'zingizga yoqqan tort rasmini yuklang va bizga qanday tort kerakligini yozib qoldiring.",
    additionalNote: "Qo'shimcha izoh",
    photoCommentPlaceholder: "Masalan: Shokaladli biskvit, ustiga tabrik so'zlari yoki tort o'lchamlari...",
    pleaseUploadImage: "Iltimos, rasm yuklang",
    imageTooLarge: "Rasm hajmi juda katta (maksimal 10MB). Iltimos, kichikroq rasm tanlang.",
    photoCakeName: "Maxsus tort (Rasm asosida)",
    asAgreed: "Kelishilgan holda",
    customerChoice: "Mijoz tanlovi",
    uploadError: "Rasm yuklashda xatolik yuz berdi. Iltimos qayta urinib ko'ring.",
};
...
const ru: Record<string, string | string[]> = {
    ...
    photoPriceNote: "📸 Цена торта по фото будет согласована с администратором после размещения заказа.",
    ...
    stepSponge: "Бисквит",
    stepCream: "Крем",
    stepDecoration: "Декор",
    stepReview: "Проверка",
    selectShape: "Выберите форму торта",
    noShapes: "Форм нет",
    selectSize: "Выберите размер",
    diameter: "диаметр",
    sizePriceNote: "Итоговая цена может отличаться в зависимости от выбранного размера.",
    selectSponge: "Выберите вид бисквита (основы)",
    selectCream: "Выберите вид крема",
    addDecorations: "Добавьте украшения",
    specialMessage: "Особое сообщение",
    textMode: "Текст",
    drawingMode: "Рисование",
    messagePlaceholder: "Например: С днём рождения!",
    ...
    howToCreate: "Как вы хотите создать торт?",
    stepByStep: "Пошагово",
    stepByStepDesc: "Выберите форму, размер и украшения самостоятельно",
    uploadPhoto: "Загрузить фото",
    uploadPhotoDesc: "Загрузите фотографию торта, который вам нравится",
    uploadPhotoFormDesc: "Загрузите фотографию понравившегося торта и опишите, какой торт вам нужен.",
    additionalNote: "Дополнительный комментарий",
    photoCommentPlaceholder: "Например: Шоколадный бисквит, надпись сверху или размеры торта...",
    pleaseUploadImage: "Пожалуйста, загрузите изображение",
    imageTooLarge: "Изображение слишком большое (максимум 10МБ). Пожалуйста, выберите меньшее изображение.",
    photoCakeName: "Особый торт (по фото)",
    asAgreed: "По договорённости",
    customerChoice: "Выбор клиента",
    uploadError: "Ошибка загрузки изображения. Пожалуйста, попробуйте снова.",
};
